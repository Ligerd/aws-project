...
INSERT INTO public."OrderDetails" ("orderDate", "shipmentDate","shipmentStatus")
...
INSERT INTO public."Orders" ("customerId", "orderedProducts", "totalPrice")
VALUES (1, '{1,2}', 11000),
       (2, '{7,8,4}', 170000),
       (3, '{5,5}', 20000);


INSERT INTO public."Delivery" ("orderId", city, "postCode",street,"houseNumber")
